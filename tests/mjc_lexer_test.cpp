...
TEST_CASE("Lexical analysis", "[lexer]") {
  ...
  auto lexer = Lexer::create(filePath, strTable.get());
  REQUIRE(lexer);
  auto const expectedTokens = std::array{
      Token(Token::Kind::e_CLASS),
      Token(Token::Kind::e_IDENTIFIER, strTable->insert("Factorial")),
      ...
      Token(Token::Kind::e_IDENTIFIER, strTable->insert("a")),
      Token(Token::Kind::e_RPAREN),
      Token(Token::Kind::e_LBRACE),
      Token(Token::Kind::e_PRINTLN),
      Token(Token::Kind::e_LPAREN),
      Token(Token::Kind::e_NEW),
      Token(Token::Kind::e_IDENTIFIER, strTable->insert("Fac")),
      Token(Token::Kind::e_LPAREN),
      Token(Token::Kind::e_RPAREN),
      Token(Token::Kind::e_DOT),
      Token(Token::Kind::e_IDENTIFIER, strTable->insert("ComputeFac")),
      Token(Token::Kind::e_LPAREN),
      ...
      Token(Token::Kind::e_LPAREN),
      Token(Token::Kind::e_INT),
      Token(Token::Kind::e_IDENTIFIER, strTable->insert("num")),
      Token(Token::Kind::e_RPAREN),
      Token(Token::Kind::e_LBRACE),
      Token(Token::Kind::e_INT),
      Token(Token::Kind::e_IDENTIFIER, strTable->insert("num_aux")),
      Token(Token::Kind::e_SEMI),
